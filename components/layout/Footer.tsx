        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">PortfolioTracker</h3>
                <p className="text-sm text-gray-400">Professional Dashboard</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering investors with real-time portfolio insights, comprehensive analytics, 
              and intelligent decision-making tools for optimal investment management.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">support@portfoliotracker.com</span>
              </li>
              <li className="flex items-center space-x-2">
